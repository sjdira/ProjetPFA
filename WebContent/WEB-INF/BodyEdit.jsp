...
<head>
	...
	<title>Modification En Stock</title>
	<!-- Required meta tags-->
    <meta charset="UTF-8">
           		...
           		<div class="col-md-12" style="margin-top: 90px;">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header"  align="center">
                                        <strong>Modification </strong> En stock
                                    </div>
                                    ...
                                    <div class="card-footer" align="center">
                                        ...
                                        <input type="hidden" id="today" name="Statut" class="form-control" value="${ statut }" >
                                        <input type="hidden" id="today" name="IdSerie3" class="form-control" value="${ idhidden }" >
                                        <button type="submit" class="btn btn-danger btn-sm" align="center" >
                                            <i class="fa fa-undo"></i> Supprimer	
                                        </button>
                                        </form>
                                    </div>
