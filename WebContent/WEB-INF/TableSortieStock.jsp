                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header" align="center" style="background-color: hotpink;">
                                <strong class="card-title" style="color: white;">Sortie Matériel</strong>
                            </div>
                            ...
                            <div class="row from-group" align="center">
                             <div class="col-md-12">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="ens" items="${ SortieStock }">
                                        <tr>
                                            <td>
                                            	<c:out value="${ ens.getNserie() }" />
                                            </td>
                                            <td>
                                            	<c:out value="${ ens.getMateriel() }" />
                                            </td>
                                            <td>
                                            	<c:out value="${ ens.getMarque() }" />
                                            </td>
                                            <td>
                                            	<c:out value="${ ens.getModel() }" />
                                            </td>
                                            <td>
                                            	<c:out value="${ ens.getStatut() }" />
                                            </td>
                                            <td>
                                            	<c:out value="${ ens.getDate() }" />
                                            </td>
                                        	<td>
                                        		<c:out value="${ ens.getResponsableSortie() }" />
                                        	</td>
                                        	<td>
                                        		<c:out value="${ ens.getDirection() }" />
                                        	</td>
