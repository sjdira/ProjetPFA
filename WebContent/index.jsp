...
.connecter:not(:disabled):not(.disabled).active, .connecter:not(:disabled):not(.disabled):active,
	.show>.connecter.dropdown-toggle {
	color: #fff;
	background-color: RGB(62, 111, 218);
	border-color: RGB(62, 111, 218);
}

.connecter:not(:disabled):not(.disabled).active:focus, .connecter:not(:disabled):not(.disabled):active:focus,
	.show>.connecter.dropdown-toggle:focus {
